...
// Initialisation
    ...
    String[] specialButtonText = {"Bkspc", "C", "CE" };
    ...
    MyCalculator(String frameText)
    {
        ...
        add(memLabel);
// setting co-ordinates for the memory buttons
        tempX=TOPX;
...
//setting co-ordinates for the special buttons
...
//setting co-ordinates for the number buttons
...
//setting the co-ordinates of the operation buttons
...
//this looks for backspace selected on keyboard
...
//clears fields when ce is selected
        if(opText.equals("C"))
        {
